<template>
  <div class="bg-black">
    <div
      ...
      style="
        height: 900px;
        background-image: url('https://occ-0-55-56.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABeu2dQHaqcOxJtNcYdUV8DOKA9CjQ2El0iPmzRbz0RF28VFE2LfntFc72Wixi3MudQSlu4aVYPldx1hoqJ-DAsofUQaO.webp');
        box-shadow: inset 0 0 200px 70px #000;
        background-size: cover;
        background-repeat: no-repeat;
        background-position: center center;
      "
    >
      <div class="relative top-32 px-16">
        <img
          class="h-76"
        ...
        <div class="flex mt-8 flex-col gap-6">
          <p class="text-white text-2xl font-normal text-justify w-5/12">
            ...
            voient leur rivalité ravivée dans cette suite de la saga "Karaté
            Kid".
          </p>
