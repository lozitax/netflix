<template>
  <div class="h-screen">
    <img
      class="w-full relative -top-20 filter brightness-75"
      src="https://occ-0-55-56.1.nflxso.net/dnm/api/v6/6AYY37jfdO6hpXcMjf9Yu5cnmO0/AAAABeu2dQHaqcOxJtNcYdUV8DOKA9CjQ2El0iPmzRbz0RF28VFE2LfntFc72Wixi3MudQSlu4aVYPldx1hoqJ-DAsofUQaO.webp"
      alt=""
    />
    <div class="absolute top-32 px-16">
      <img
        class="h-76"
        src="https://occ-0-55-56.1.nflxso.net/dnm/api/v6/LmEnxtiAuzezXBjYXPuDgfZ4zZQ/AAAABW52ftDick7TEXR_ADxCu5ARxiZ_66guBi83QOxUn7LmldU1WweeWveRurWs5GTJ-OvHnBd_j6oXG0pt5NM0EbOl7E1BYTDE4fLkpUKooiG4GHT_7tDuyUslimRuprmejDAZ7GsNS4Hi3RairQNAwGpQj1gh2hDtIN_dbDUSOLajcA.webp?r=63f"
        alt=""
      />
      <div class="mt-4 flex items-center gap-4">
        ...
        <p class="text-white text-3xl font-medium">N°3 en France aujoud'hui</p>
      </div>
      <div class="flex mt-8 flex-col gap-6">
        <p class="text-white text-2xl font-normal text-justify w-5/12">
          Trente ans après le tournoi qui a changé leur vie, Johnny et Daniel
          voient leur rivalité ravivée dans cette suite de la saga "Karaté Kid".
        </p>
      ...
      <div class="mt-36">
        <div class="flex flex-col gap-4">
          <p class="text-3xl text-white font-medium">Hollywood</p>
          <div class="flex gap-2 overflow-x-scroll">
            <img
              class="h-40 rounded-md"
              src="https://occ-0-55-56.1.nflxso.net/dnm/api/v6/X194eJsgWBDE2aQbaNdmCXGUP-Y/AAAABc1P19vTjpGDkLcl9zNqUE7C_8P1gxRNE5caGjb55riLJprMkFrFYVWllWQq7Zhhdh8BTO4LPvEI0HS5hMFbcnQRkLvMqw_t65D_fen8P46lh218MYUTJPjOkEhGOI3lq_0iXR8Px472evt2hxD_Qe58xLfRcQwNm6rVX3ZhndcnKM5Zs9XAgq8.jpg?r=aff"
              alt=""
            />
            <img
              class="h-40 rounded-md"
